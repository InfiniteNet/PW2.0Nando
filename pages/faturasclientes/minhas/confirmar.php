...
$GLOBALS["vnrbipbiq"] = "fatu";
$GLOBALS["ubezbkheead"] = "conta";
$GLOBALS["ngdfnnw"] = "SQLUPUser";
$GLOBALS["xrodxhjrahj"] = "fatura_id";
...
if (isset($_GET["id"])) {
    ${$GLOBALS["xrodxhjrahj"]} = $_GET["id"];
    ${$GLOBALS["ngdfnnw"]} = "SELECT * FROM fatura where id='" . ${$GLOBALS["xrodxhjrahj"]} . "'";
    $pwxbretnlke = "conta";
    ${$GLOBALS["ngdfnnw"]} = $conn->prepare(${$GLOBALS["ngdfnnw"]});
    $SQLUPUser->execute();
    ${$GLOBALS["ubezbkheead"]} = $SQLUPUser->rowCount();
    $GLOBALS["jrwshpato"] = "fatu";
    $GLOBALS["fsnljrnffp"] = "fatu";
    $jyshgpqftff = "fatu";
    if (${$pwxbretnlke} == 0) {
        echo "<script type=\"text/javascript\">";
    ...
    ${$GLOBALS["vnrbipbiq"]} = $SQLUPUser->fetch();
    if (${$jyshgpqftff}["usuario_id"] != $_SESSION["usuarioID"]) {
        echo "<script type=\"text/javascript\">";
    ...
    if (${$GLOBALS["fsnljrnffp"]}["status"] == "cancelado") {
        echo "<script type=\"text/javascript\">";
    ...
    if (${$GLOBALS["jrwshpato"]}["status"] == "pago") {
        echo "<script type=\"text/javascript\">";
...
$GLOBALS["vvxgxhndkds"] = "fatu";
echo ${$GLOBALS["vnrbipbiq"]}["id"];
