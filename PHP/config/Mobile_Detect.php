...
$GLOBALS["iudtdxlgyqw"] = "isMobile";
$GLOBALS["toywcbrr"] = "propertyPattern";
$GLOBALS["ejmiigtjcq"] = "propertyMatchString";
$GLOBALS["bezqhx"] = "propertyName";
$GLOBALS["zgyttewcnt"] = "arrVer";
$GLOBALS["xtumwqhrx"] = "ver";
$GLOBALS["iweeaezl"] = "properties";
$GLOBALS["qdkvxemkx"] = "match";
$GLOBALS["fqnvfyixyxf"] = "matches";
$GLOBALS["ibuilyxmyjmn"] = "regex";
$GLOBALS["kipgccpz"] = "_regex";
$GLOBALS["huvximf"] = "_rules";
$GLOBALS["cptbkuicm"] = "name";
$GLOBALS["gklepsm"] = "_match";
$GLOBALS["qsdosppojq"] = "matchType";
$GLOBALS["bhthdxnljvv"] = "mobileHeader";
$GLOBALS["gjmlevi"] = "utilities";
$GLOBALS["pxfbss"] = "operatingSystems";
$GLOBALS["msqxroymn"] = "phoneDevices";
$GLOBALS["whsiuifdybd"] = "rules";
$GLOBALS["rculgx"] = "browsers";
$GLOBALS["jyhqkd"] = "tabletDevices";
$GLOBALS["idqysqoque"] = "type";
$GLOBALS["hnvncey"] = "userAgent";
$GLOBALS["ipzzouhnhjn"] = "response";
$GLOBALS["grigithord"] = "cfHeaders";
$GLOBALS["syluosdmmb"] = "uaHttpHeaders";
$GLOBALS["pwsxyispe"] = "mobileHeaders";
$GLOBALS["joudcrzne"] = "altHeader";
$GLOBALS["ucvzpkstcnnw"] = "header";
$GLOBALS["ggemzhx"] = "key";
$GLOBALS["dpqiqh"] = "value";
$GLOBALS["tnwlhnbrvxu"] = "httpHeaders";
class Mobile_Detect
{
    ...
    {
        $jsytlckvwmr = "key";
        $lyyoulkbeqkl = "httpHeaders";
        if (!is_array($httpHeaders) || !count($httpHeaders)) {
            $httpHeaders = $_SERVER;
        }
        $this->httpHeaders = array();
        foreach ($httpHeaders as ${$jsytlckvwmr} => $value) {
    ...
    {
        return self::${$GLOBALS["pwsxyispe"]};
    }
    public function getUaHttpHeaders()
    {
        return self::${$GLOBALS["syluosdmmb"]};
    }
    public function setCfHeaders($cfHeaders = null)
    {
        ...
        $response = false;
        foreach ($cfHeaders as $key => ${$pksikgnpskr}) {
            $GLOBALS["omdusilpogm"] = "key";
            if (substr(strtolower($key), 0, 16) === "http_cloudfront_") {
                $hktcvyhu = "response";
                $GLOBALS["kyiupqyh"] = "key";
    ...
    {
        $ghmrmyb = "phoneDevices";
        return self::${$ghmrmyb};
    }
    public static function getTabletDevices()
    {
        return self::${$GLOBALS["jyhqkd"]};
    }
    ...
    {
        return self::${$GLOBALS["rculgx"]};
    }
    public static function getUtilities()
    {
        $fatxhsvy = "utilities";
        return self::${$fatxhsvy};
    }
    public static function getMobileDetectionRules()
    {
        ...
        $ikndnmegw = "rules";
        if (!$rules) {
            $GLOBALS["tgnhzvrfuw"] = "rules";
            $GLOBALS["tecpkg"] = "phoneDevices";
            $GLOBALS["jnlmiofb"] = "operatingSystems";
            $ciqjeywqqu = "browsers";
            $rules = array_merge(self::${$GLOBALS["tecpkg"]}, self::${$GLOBALS["jyhqkd"]}, self::${$GLOBALS["jnlmiofb"]}, self::${$ciqjeywqqu});
        }
        return $rules;
    }
    public function getMobileDetectionRulesExtended()
    {
        $GLOBALS["hzhuieymb"] = "rules";
        static $rules;
        if (!$rules) {
            $icxmyobn = "rules";
            $rules = array_merge(self::${$GLOBALS["msqxroymn"]}, self::${$GLOBALS["jyhqkd"]}, self::${$GLOBALS["pxfbss"]}, self::${$GLOBALS["rculgx"]}, self::${$GLOBALS["gjmlevi"]});
        }
        return $rules;
    }
    ...
    {
        $GLOBALS["mfnwbo"] = "operatingSystems";
        return self::${$GLOBALS["mfnwbo"]};
    }
    public function checkHttpHeadersForMobile()
    {
        $GLOBALS["jxjfprleziio"] = "matchType";
        foreach ($this->getMobileHeaders() as $mobileHeader => $matchType) {
            $GLOBALS["qtntcukppd"] = "mobileHeader";
            if (isset($this->httpHeaders[$mobileHeader])) {
                $jqsycktlxj = "matchType";
    ...
    protected function matchDetectionRulesAgainstUA($userAgent = null)
    {
        ...
        foreach ($this->getRules() as $_regex) {
            ...
            if ($this->match(${$whptskzjpg}, $userAgent)) {
                return true;
            }
        }
        return false;
    ...
    {
        $GLOBALS["fhcrworgq"] = "key";
        $GLOBALS["rannxjf"] = "key";
        $key = strtolower($key);
        if (false === isset($this->cache[$key])) {
            $GLOBALS["zexymprkrg"] = "_rules";
            $GLOBALS["mcfzobj"] = "_rules";
    ...
    public function isTablet($userAgent = null, $httpHeaders = null)
    {
        ...
        $ltfcdhqqutcs = "_regex";
        $GLOBALS["qiujxzg"] = "tabletDevices";
        $this->setDetectionType(self::DETECTION_TYPE_MOBILE);
        foreach (self::${$GLOBALS["qiujxzg"]} as $_regex) {
    ...
    {
        $cvjbjltx = "httpHeaders";
        if ($httpHeaders) {
            $this->setHttpHeaders($httpHeaders);
        }
        if ($userAgent) {
            $qytvbrjgwfde = "userAgent";
            $this->setUserAgent($userAgent);
        }
        $this->setDetectionType(self::DETECTION_TYPE_EXTENDED);
        $GLOBALS["ttinzhrhms"] = "key";
        return $this->matchUAAgainstKey($key);
    }
    public function match($regex, $userAgent = null)
    {
        $vaisbkpciiy = "userAgent";
        $GLOBALS["ziszzuntzgy"] = "match";
        $hpvorfn = "match";
        if (!\is_string($userAgent) && !\is_string($this->userAgent)) {
            return false;
        }
        ${$hpvorfn} = (bool) preg_match(sprintf("#%s#is", $regex), false === empty(${$vaisbkpciiy}) ? $userAgent : $this->userAgent, $matches);
        if ($match) {
            $rifuhnksqv = "regex";
            $gjdcurnmmfn = "matches";
    ...
    {
        return self::${$GLOBALS["iweeaezl"]};
    }
    public function prepareVersionNo($ver)
    {
        $GLOBALS["jeidur"] = "ver";
        $GLOBALS["cgucqvunjoyf"] = "arrVer";
        $qepwlisnpe = "arrVer";
        $GLOBALS["zqrwjsdxtj"] = "ver";
    ...
    public function version($propertyName, $type = self::VERSION_TYPE_STRING)
    {
        ...
        if (true === isset($properties[$propertyName])) {
            $bffdueletu = "propertyName";
            $GLOBALS["dilhfggc"] = "propertyName";
            $giierbjj = "properties";
            $iwudxfrd = "properties";
            $GLOBALS["ypqumcfsru"] = "properties";
            $properties[$propertyName] = (array) $properties[$propertyName];
            foreach ($properties[$propertyName] as $propertyMatchString) {
                $emjpbwa = "match";
                $kgckdffl = "propertyMatchString";
                $hmwjwkipx = "propertyPattern";
                $propertyPattern = str_replace("[VER]", self::VER, $propertyMatchString);
                $GLOBALS["jmijokvjqsjx"] = "match";
                preg_match(sprintf("#%s#is", $propertyPattern), $this->userAgent, $match);
                if (false === empty($match[1])) {
                    $GLOBALS["ielriqmf"] = "version";
                    $jnavhgnvesy = "match";
                    $GLOBALS["oaxiumugd"] = "version";
    ...
    {
        $GLOBALS["eiovgxvihtn"] = "isMobile";
        $isMobile = $this->isMobile();
        $wmkrxpwlrwob = "isMobile";
